...
This role also relies on the presence of the `drush_path` variable, which is used to run drush. This could be, simply, `drush` on your system (if drush is in your user's `$PATH`).
